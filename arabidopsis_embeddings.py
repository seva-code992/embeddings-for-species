...
############################################################################################################################################################################################################################################
#Compute the embeddings for Arabidopsis#
############################################################################################################################################################################################################################################
...
p= Path(__file__).resolve().parent / "arabidopsis.csv"
...
print(f"These are the first 10 lines of IDs with their description for Arabidopsis: {list(zip(ID, description))[:10]}")


gene_ids_file = "arabidopsis-gene-ids.npy"
embeddings_file = "arabidopsis-embeddings.npy"
...
if os.path.exists(embeddings_file):
    ...
    print(f"Computing embeddings for {len(description)} gene descriptions for Arabidopsis...")
